  ...
  <div class="content-wrapper">
    <div class="row align-items-center py-4">
      ...
      <div class="col-8 text-right">
        <a data-toggle="modal" data-target="#single-charge" href="" class="btn btn-sm btn-neutral"><i class="fal fa-plus"></i> {{__('Create Payment Link')}}</a> 
      </div>
    </div>
    <div class="row">
      <div class="col-md-12">
                    ...
                    <div class="row mb-2">
                      ...
                      <div class="col-8 text-right">
                        ...
                        <div class="dropdown-menu dropdown-menu-left">
                          @if($val->active==1)
                              <a class='dropdown-item' href="{{route('sclinks.unpublish', ['id' => $val->id])}}"><i class="fal fa-ban"></i>{{ __('Disable')}}</a>
                          @else
                              <a class='dropdown-item' href="{{route('sclinks.publish', ['id' => $val->id])}}"><i class="fal fa-check"></i>{{ __('Activate')}}</a>
                          @endif
