  ...
  <div class="content-wrapper">
    <div class="row align-items-center py-4">
      ...
      <div class="col-lg-6 col-5 text-right">
        <a href="{{route('user.add-invoice')}}" class="btn btn-sm btn-neutral"><i class="fal fa-plus"></i> {{__('Create an invoice')}}</a> 
      </div>
    </div>
    <div class="row">  
      <div class="col-md-8">
                  ...
                  <div class="card-body">
                      ...
                      <div class="col-8 text-right">
                        ...
                        <div class="dropdown-menu dropdown-menu-left">
                          @if($val->status==0)
                            ...
                            <a class="dropdown-item" href="{{route('paid.invoice', ['id' => $val->ref_id])}}"><i class="fal fa-check"></i>{{__('Mark as Paid')}}</a>
                            <a class="dropdown-item" href="{{route('reminder.invoice', ['id' => $val->ref_id])}}"><i class="fal fa-sync"></i>{{__('Resend')}}</a>
                          @endif
                    ...
                    <div class="row align-items-center">
                      <div class="col">
                        ...
                        <p>{{__('Tax')}}: {{$val->tax}}%</p>
                        <p>{{__('Discount')}}: {{$val->discount}}%</p>
                        <p>{{__('Total')}}: {{$currency->symbol.number_format($val->total)}}</p>
            ...
            <div class="card-body">
              <div class="row align-items-center">
                <div class="col">
                  ...
                  <p>{{__('Payment link')}} <button type="button" class="btn-icon-clipboard" data-clipboard-text="{{route('view.invoice', ['id' => $val->ref_id])}}" title="Copy"><i class="fa fa-copy"></i></button></p>
                  @if($val->status==1)
                    <span class="badge badge-pill badge-success"><i class="fa fa-check"></i> {{__('Paid')}}</span>
                  @elseif($val->status==0)
                    <span class="badge badge-pill badge-danger"><i class="fa fa-spinner"></i> {{__('Pending')}}</span>                    
