      ...
      <div class="col-md-12">
        ...
        <div class="card">
          <div class="card-header">
            ...
            <span class="form-text text-xs">Invoice charge is {{$set->invoice_charge}}%. Invoice is charged when invoice is paid by client. </span>
          </div>
          <div class="card-body">
            <form action="{{route('submit.invoice')}}" method="post">
              ...
              <div class="form-group row">
                ...
                <div class="col-lg-4">
                  <div class="input-group">
                    <input type="number" name="tax" step="any" class="form-control" placeholder="" required>
                    <span class="input-group-append">
                      <span class="input-group-text">%</span>
                    </span>
                  </div>
                ...
                <div class="col-lg-4">
                  <div class="input-group">
                    <input type="number" name="discount" step="any" class="form-control" placeholder="" required>
                    <span class="input-group-append">
                        <span class="input-group-text">%</span>
                      </span>
                  </div>
              ...
              <div class="text-left">
                <button type="submit" class="btn btn-neutral btn-sm">{{__('Create Invoice')}}</a>
              </div>         
            </form>
          </div>
        </div>
