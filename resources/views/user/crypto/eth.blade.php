  ...
  <div class="content-wrapper">
    <div class="row align-items-center py-4">
      ...
      <div class="col-8 text-right">
        <a data-toggle="modal" data-target="#buy-eth" href="" class="btn btn-sm btn-neutral"><i class="fal fa-plus"></i> {{__('Buy Ethereum')}}</a>
        <a data-toggle="modal" data-target="#sell-eth" href="" class="btn btn-sm btn-neutral"><i class="fal fa-plus"></i> {{__('Sell Ethereum')}}</a>
      </div>
    </div>
    <div class="row">
      <div class="col-md-12">
