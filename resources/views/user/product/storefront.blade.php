            ...
            <div class="col-md-12">
                <div class="nav-wrapper">
                    <ul class="nav nav-pills nav-fill flex-column flex-md-row" id="tabs-icons-text" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link mb-sm-3 mb-md-0 @if(route('user.storefront')==url()->current()) active @endif" id="tabs-icons-text-1-tab" data-toggle="tab" href="#tabs-icons-text-1" role="tab" aria-controls="tabs-icons-text-1" aria-selected="true"><i class="fal fa-store-alt"></i> Store front</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link mb-sm-3 mb-md-0 @if(route('user.shipping')==url()->current()) active @endif" id="tabs-icons-text-2-tab" data-toggle="tab" href="#tabs-icons-text-2" role="tab" aria-controls="tabs-icons-text-2" aria-selected="false"><i class="fal fa-street-view"></i> Shipping Regions & Rate</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link mb-sm-3 mb-md-0 @if(route('user.product')==url()->current()) active @endif" id="tabs-icons-text-3-tab" data-toggle="tab" href="#tabs-icons-text-3" role="tab" aria-controls="tabs-icons-text-3" aria-selected="false"><i class="fal fa-shopping-bag"></i> Products</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link mb-sm-3 mb-md-0 @if(route('user.list')==url()->current()) active @endif" id="tabs-icons-text-4-tab" data-toggle="tab" href="#tabs-icons-text-4" role="tab" aria-controls="tabs-icons-text-4" aria-selected="false"><i class="fal fa-shopping-cart"></i> Client Orders</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link mb-sm-3 mb-md-0 @if(route('user.your-list')==url()->current()) active @endif" id="tabs-icons-text-5-tab" data-toggle="tab" href="#tabs-icons-text-5" role="tab" aria-controls="tabs-icons-text-5" aria-selected="false"><i class="fal fa-shopping-cart"></i> Your Orders</a>
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <div class="tab-pane fade @if(route('user.storefront')==url()->current())show active @endif" id="tabs-icons-text-1" role="tabpanel" aria-labelledby="tabs-icons-text-1-tab">
                <div class="row align-items-center py-4">
                    <div class="col-lg-6 col-5 text-left">
                        <a data-toggle="modal" data-target="#new-store" href="" class="btn btn-sm btn-neutral"><i class="fal fa-plus"></i> {{__('New Storefront')}}</a>
                    </div>
                </div>
                <div class="card">
                    <div class="table-responsive py-4">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                            <a href="{{route('storefront.products', ['id' => $val->id])}}" class="dropdown-item"><i class="fal fa-shopping-bag"></i> {{__('Products')}}</a>
                                            <a href="{{route('store.your-list', ['id' => $val->id])}}" class="dropdown-item"><i class="fal fa-shopping-cart"></i> {{__('Orders')}}</a>
                                            <a data-toggle="modal" data-target="#edit{{$val->id}}" href="" class="dropdown-item"><i class="fal fa-pencil"></i>{{__('Edit')}}</a>
                                            @if($val->status==1)
                                                <a class='dropdown-item' href="{{route('store.unpublish', ['id' => $val->id])}}"><i class="fal fa-ban"></i>{{ __('Disable')}}</a>
                                            @else
                                                <a class='dropdown-item' href="{{route('store.publish', ['id' => $val->id])}}"><i class="fal fa-check"></i>{{ __('Activate')}}</a>
                                            @endif
                                ...
                                <td><a class="btn-icon-clipboard text-uppercase" data-clipboard-text="{{route('store.link', ['id' => $val->store_url])}}" title="Copy">Copy Link <i class="fal fa-link text-xs"></i></a></td>
                                <td>{{$currency->name.' '.$val->revenue}}</td>
                            </tr>
                            @endforeach
                        </tbody>
                        </table>
            ...
            <div class="tab-pane fade @if(route('user.shipping')==url()->current())show active @endif" id="tabs-icons-text-2" role="tabpanel" aria-labelledby="tabs-icons-text-2-tab">
                <div class="row align-items-center py-4">
                    <div class="col-lg-8 col-8 text-left">
                        <a data-toggle="modal" data-target="#new-shipping" href="" class="btn btn-sm btn-neutral"><i class="fal fa-plus"></i> {{__('New Add Shipping Fee')}}</a>
                    </div>
                </div>
                <div class="card">
                    <div class="table-responsive py-4">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                            <a data-toggle="modal" data-target="#editship{{$val->id}}" href="" class="dropdown-item"><i class="fal fa-pencil"></i>{{__('Edit')}}</a>
                                            <a class="dropdown-item" data-toggle="modal" data-target="#deleteship{{$val->id}}" href=""><i class="fal fa-trash"></i>{{__('Delete')}}</a>
                                        </div>
                                    </div>
                                </td>
                                <td>{{$val->region}}</td>
            ...
            <div class="tab-pane fade @if(route('user.product')==url()->current())show active @endif" id="tabs-icons-text-3" role="tabpanel" aria-labelledby="tabs-icons-text-3-tab">
                <div class="row align-items-center py-4">
                    ...
                    <div class="col-8 text-right">
                        <a data-toggle="modal" data-target="#category" href="" class="btn btn-sm btn-neutral"><i class="fal fa-filter"></i> {{__('Category')}}</a>
                        <a data-toggle="modal" data-target="#new-product" href="" class="btn btn-sm btn-neutral"><i class="fal fa-plus"></i> {{__('Create Product')}}</a>
                    </div>
                </div>
                                ...
                                <ul class="list-group list-group-flush list">
                                    ...
                                    @foreach($category as $k=>$val)
                                        ...
                                        <div class="row align-items-center">
                                            ...
                                            <a href="{{route('delete.category', ['id' => $val->id])}}" class="btn btn-sm btn-neutral"><i class="fal fa-trash"></i> {{__('Delete')}}</a>
                                            </div>
                                        </div>
                                        </li>
                                    @endforeach
                            ...
                            <div class="card">
                                ...
                                <div class="row mb-0">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-left">
                                        <a class="dropdown-item" href="{{route('edit.product', ['id' => $val->ref_id])}}"><i class="fal fa-pencil"></i>{{__('Edit')}}</a>
                                        <a class="dropdown-item" href="{{route('orders', ['id' => $val->id])}}"><i class="fal fa-sync"></i>{{__('Orders')}}</a>
                                        <a class="dropdown-item" data-toggle="modal" data-target="#delete{{$val->id}}" href="#"><i class="fal fa-trash-alt"></i>{{__('Delete')}}</a>
                                    </div>
                                    </div>
                                </div>
                                <div class="row align-items-center">
                                    <div class="col-auto">
                                    <!-- Avatar -->
                                    <a href="{{route('edit.product', ['id' => $val->ref_id])}}" class="avatar avatar-xl">
                                        <img
                                        @if($val->new==0)
                                    ...
                                    <p class="text-sm mb-2"><a class="btn-icon-clipboard text-uppercase" data-clipboard-text="{{route('user.ask', ['id' => $val->ref_id])}}" title="Copy">{{__('Copy Product Link')}}</a></p>
                                    @if($val->status==1)
                                        <span class="badge badge-pill badge-primary"><i class="fal fa-check"></i> {{__('Active')}}</span>
                                    @else
                                        <span class="badge badge-pill badge-danger">{{__('Disabled')}}</span>
