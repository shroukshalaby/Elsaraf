            ...
            <div class="card-body">
                <form action="{{route('submit.storeproduct')}}" method="post">
                    ...
                    <div class="text-right">
                        <button type="submit" class="btn btn-neutral btn-block"><i class="fal fa-external-link"></i> {{__('Add Product')}}</button>
                    </div>
                            ...
                            @foreach($product as $k=>$val)
                                ...
                                <li class="list-group-item px-0">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-auto">
                                        <a href="{{route('delete.storefrontproduct', ['id' => $val->id])}}" class="btn btn-sm btn-neutral"><i class="fal fa-trash"></i> {{__('Delete')}}</a>
                                        </div>
                                    </div>
                                </li>
                            @endforeach
