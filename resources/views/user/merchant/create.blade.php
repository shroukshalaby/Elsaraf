          ...
          <div class="card-body">
            <form action="{{route('submit.merchant')}}" enctype="multipart/form-data" method="post">
              ...
              <div class="form-group row">
                ...
                <div class="col-lg-10">
                  <input type="text" name="merchant_name" class="form-control" placeholder="Name of your website" required>
                </div>
              </div>
              <div class="form-group row">
                ...
                <div class="col-lg-10">
                  <div class="input-group">
                    <textarea type="text" class="form-control" rows="4" placeholder="Page description or extra instructions"  name="merchant_description" required></textarea>
                  </div>
                </div>
              </div>
              <div class="form-group row">
              ...
              <div class="form-group row">
                  <label class="col-form-label col-lg-2">{{__('Seo Image')}}</label>
                  <div class="col-lg-10">
