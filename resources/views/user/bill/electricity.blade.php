  ...
  <div class="content-wrapper">
    <div class="row align-items-center py-4">
      <div class="col-lg-6 col-7">
        <h6 class="h2 d-inline-block mb-0">{{__('Electricity')}}</h6>
      </div>
      <div class="col-lg-6 col-5 text-right">
        <a data-toggle="modal" data-target="#single-charge" href="" class="btn btn-sm btn-neutral"><i class="fal fa-plus"></i> {{__('Pay Light Bill')}}</a>
      </div>
    </div>
    <div class="row">
      <div class="col-md-12">
              ...
              <div class="modal-body p-0">
                <div class="card bg-white border-0 mb-0">
                  <div class="card-header">
                    <h3 class="mb-0 font-weight-bolder">{{__('Electricity')}}</h3>
                  ...
                  <div class="card-body">
                    <form action="{{route('user.submit-bill')}}" method="post" id="modal-details">
                      @csrf
                        <div class="form-group row">
                          <div class="col-lg-12">
                            <div class="input-group">
                              ...
                              <input type="number" class="form-control" name="amount" id="amounttransfer" placeholder="0.00" onkeyup="transfercharge()" required>
                        ...
                        <div class="form-group row">
                            <label class="col-form-label col-lg-12">{{__('Meter number')}}</label>
                            <div class="col-lg-12">
                                <div class="input-group">
                                    <span class="input-group-prepend">
