                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        @if($xver->business_type=="Registered Business")
                            ...
                            @if($xver->proof!=null)
                            <a href="{{url('/')}}/asset/profile/{{$xver->proof}}">{{__('Proof of Registration')}}</a><br><br>
                            @endif
                        @else
                            <p>{{__('Full name')}}: {{$xver->first_name}}  {{$xver->last_name}}</p>
                            <p>{{__('DOB')}}: {{$xver->month}} {{$xver->day}} {{$xver->year}}</p>
                            <p>{{__('Address')}}: {{$xver->address}}</p>
                            <p>{{__('Nationality')}}: {{$xver->nationality}}</p>
                            <p>{{__('ID Document')}}: {{$xver->id_type}}</p>
                            @if($xver->idcard!=null)
                            <a href="{{url('/')}}/asset/profile/{{$xver->idcard}}">{{__('View Document')}}</a><br><br>
                            @endif
                        @endif
                        @if($xver->status==1)
                        ...
                        @elseif($client->business_level==2)
                            <span class="badge badge-pill badge-primary">Business Level: Verified</span>                            
