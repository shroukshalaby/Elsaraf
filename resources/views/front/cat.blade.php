                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <div class="card blog-grid-1 box-shadow-hover">
                            <div class="blog-img">
                                <a href="{{url('/')}}/single/{{$vblog->id}}/{{Str::slug($vblog->title)}}">
                            ...
                            <div class="card-body blog-info">
                                <h5>
                                    <a href="{{url('/')}}/single/{{$vblog->id}}/{{Str::slug($vblog->title)}}">{!!  Str::limit($vblog->title, 40);!!}..</a>
                                </h5>
                                <p class="m-0px">{!!  Str::limit($vblog->details, 80);!!}</p>
                                <div class="btn-bar">
                                    <a class="m-link-theme" href="{{url('/')}}/single/{{$vblog->id}}/{{Str::slug($vblog->title)}}">Read more</a>
                                </div>
                            </div>
                        </div>
                    </div>
