...
//Country
    ...
    {
        $mac = Countrysupported::whereid($request->id)->first();
        $mac['country_id'] = $request->country;
        $res = $mac->save();
        if ($res) {
            return redirect()->route('admin.country')->with('success', 'Saved Successfully!');
        } else {
            return back()->with('alert', 'Problem With Updating Country');
        }
    }
    public function DestroyCountry($id)
    {
        ...
        if ($res) {
            ...
            return back()->with('alert', 'Problem With Deleting Country');
        }
    }
//
...
//Bank
    ...
    public function Destroylbank($id)
    {
        ...
        if ($res) {
            ...
            return back()->with('alert', 'Problem With Deleting Bank');
        }
    }
//
